...
public class UnderscoreToCamelCaseTests extends TestCase {
    ...
    public void testBasicConversions() {
        ...
        assertEquals("myReallyLongStringVariableName",
            UnderscoreToCamelCase.convert("my_really_long_string_variable_name"));
        assertEquals("myString2WithNumbers4",
            UnderscoreToCamelCase.convert("my_string2_with_numbers_4"));
        assertEquals("myStringWithMixedCase",
            UnderscoreToCamelCase.convert("my_string_with_MixED_CaSe"));
    }
