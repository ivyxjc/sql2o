...
public class Sql2oTest extends BaseMemDbTest {
    ...
    public void testExecuteAndFetch() {
        ...
        try (Connection con = sql2o.open()) {
            ...
            System.out.println(
                String.format("Again Fetched %s user: %s ms", insertIntoUsers, span));
    ...
    public void testExecuteAndFetchWithNulls() {
        ...
        try (Connection con = sql2o.open()) {
            ...
            List<Entity> fetched =
                con.createQuery("select * from testExecWithNullsTbl").executeAndFetch(Entity.class);
    ...
    public void testCaseInsensitive() {
        ...
        List<CIEntity> ciEntities = sql2o.createQuery("select * from testCI")
    ...
    public void testExecuteAndFetchResultSet() {
        List<Integer> list = sql2o.createQuery(
    ...
    @Test
    public void testExecuteScalarListWithNulls() {
    ...
    public void testColumnAnnotation() {
        try (Connection connection = sql2o.open()) {
            ...
            connection.createQuery(
                "insert into test_column_annotation(id, text_col) values(:id, :text)")
                .addParameter("id", 1).addParameter("text", "test1").addToBatch()
                .addParameter("id", 2).addParameter("text", "test2").addToBatch()
                .executeBatch();

            List<ColumnEntity> result =
                connection.createQuery("select * from test_column_annotation")
    ...
    public void testNullDate() {
        sql2o.createQuery("create table nullDateTest(id integer primary key, somedate datetime)")
            .executeUpdate();
        ...
        Date d = (Date) sql2o.createQuery("select somedate from nullDateTest where id = 1")
            .executeScalar();
        assertNull(d);
    }
    ...
    public void testGetResult() {
        ...
        sql2o.createQuery("create table get_result_test(id integer primary key, value varchar(20))")
            .executeUpdate();
    ...
    public void testGetKeys() {
        ...
        Integer key = (Integer) sql2o.createQuery(insertSql)
        ...
        String multiInsertSql =
            "insert into get_keys_test(value) select 'a val' col1 from (values(0)) union select 'another val' col1 from (values(0))";
    ...
    public void testBigDecimals() {
        ...
        sql2o.createQuery("insert into bigdectesttable(val1, val2) values(:val1, :val2)")
            .addParameter("val1", 1.256)
            .addParameter("val2", 4)
            .executeUpdate();

        BigDecimalPojo pojo = sql2o.createQuery("select * from bigdectesttable")
    ...
    public void testQueryDbMappings() {
        Entity entity = sql2o.createQuery(
    ...
    public void testGlobalDbMappings() {
        ...
        Entity entity = sql2o1.createQuery(
            "select 1 as id, 'something' as caption, cast('2011-01-01' as date) as theTime from (values(0))")
    ...
    public void testSetPrivateFields() {
        EntityWithPrivateFields entity =
            sql2o.createQuery("select 1 id, 'hello' value from (values(0))")
    ...
    public void testFetchTable() {
        ...
        Table table =
            sql2o.createQuery("select * from tabletest order by id").executeAndFetchTable();
    ...
    public void testStringConversion() {
        StringConversionPojo pojo = sql2o.createQuery(
    ...
    public void testSuperPojo() {
        SuperPojo pojo = sql2o.createQuery("select 1 id, 'something' value from (values(0))")
    ...
    public void testComplexTypes() {
        ComplexEntity pojo = sql2o.createQuery(
    ...
    public void testRunInsideTransaction() {
        ...
        assertTrue(failed);
        long rowCount = (Long) sql2o.createQuery("select count(*) from runinsidetransactiontable")
            .executeScalar();
        ...
        rowCount = (Long) sql2o.createQuery("select count(*) from runinsidetransactiontable")
            .executeScalar();
        assertEquals(1, rowCount);
        ...
        sql2o.runInTransaction(new StatementRunnable() {
            ...
            public void run(Connection connection, Object argument) {
                ...
                String insertedValue = connection.createQuery(
                    "select value from runinsidetransactiontable where id = :id")
                    .addParameter("id", id)
    ...
    public void testUpdateWithNulls() {
        ...
        sql2o.createQuery("insert into testUpdateWithNulls_2(value) values(:val)")
            .addParameter("val", 2)
            .addToBatch()
    ...
    public void testExceptionInRunnable() {
        ...
        int c = sql2o.createQuery("select count(*) from testExceptionInRunnable")
        ...
        c = sql2o.createQuery("select count(*) from testExceptionInRunnable")
            .executeScalar(Integer.class);
        assertEquals(1, c);
    }
    ...
    public void testEnums() {
        ...
        List<EntityWithEnum> list =
            sql2o.createQuery("select id, enum_val val, enum_val2 val2 from EnumTest")
    ...
    public void testBindPojo() {
        ...
        String insertSql =
            "insert into bindtbl(data1, data2, data3) values(:data1, :data2, :data3)";
    ...
    public void testExecuteAndFetchLazy() {
        ...
        ResultSetIterable<User> allUsers =
            sql2o.createQuery("select * from User").executeAndFetchLazy(User.class);
    ...
    public void testExecuteAndFetch_fallbackToExecuteScalar() {
        ...
        List<String> userNames =
            sql2o.createQuery("select name from User").executeAndFetch(String.class);
    ...
    public void testTransactionAutoClosable() {
        ...
        int count = sql2o.createQuery("select count(*) from testTransactionAutoClosable")
        ...
        count = sql2o.createQuery("select count(*) from testTransactionAutoClosable")
            .executeAndFetchFirst(Integer.class);
    ...
    public void testExternalTransactionCommit() {
        ...
        try (Connection connection1 = sql2o.open()) {
            connection1.createQuery(
                "create table testExternalTransactionCommit(id int primary key, val varchar(20) not null)")
                .executeUpdate();
        }
        ...
        try (Connection globalConnection = sql2o.beginTransaction()) {
            ...
            try (Connection connection = sql2o.beginTransaction(join(globalTransaction))) {
                String sql =
                    "insert into testExternalTransactionCommit(id, val) values (:id, :val);";
                connection.createQuery(sql)
                    .addParameter("id", 1)
                    .addParameter("val", "foo")
                    .executeUpdate();
            ...
            try (Connection connection2 = sql2o.open(join(globalTransaction))) {
                int count =
                    connection2.createQuery("select count(*) from testExternalTransactionCommit")
                        .executeAndFetchFirst(Integer.class);
                assertThat(count, is(equalTo(1)));
            }
    ...
    public void testExternalTransactionRollback() {
        ...
        try (Connection connection1 = sql2o.open()) {
            connection1.createQuery(
                "create table testExternalTransactionRollback(id int primary key, val varchar(20) not null)")
                .executeUpdate();
        }
        ...
        try (Connection globalConnection = sql2o.beginTransaction()) {
            ...
            try (Connection connection = sql2o.beginTransaction(join(globalTransaction))) {
                String sql =
                    "insert into testExternalTransactionRollback(id, val) values (:id, :val);";
                connection.createQuery(sql)
                    .addParameter("id", 1)
                    .addParameter("val", "foo")
                    .executeUpdate();
            ...
            try (Connection connection2 = sql2o.open(join(globalTransaction))) {
                int count =
                    connection2.createQuery("select count(*) from testExternalTransactionRollback")
                        .executeAndFetchFirst(Integer.class);
                assertThat(count, is(equalTo(1)));
            }
    ...
    private void genericTestOnUserData(Connection connection) {
        List<User> users =
            connection.createQuery("select * from User order by id").executeAndFetch(User.class);
